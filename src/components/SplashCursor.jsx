...
export default function SplashCursor() {
  ...
  useEffect(() => {
    ...
    // Event listeners — render loop starts on FIRST mouse move only
    const onMouseDown = (e) => {
    ...
    // First mouse move starts the render loop
    function handleFirstMouseMove(e) {
      let posX = scaleByPixelRatio(e.clientX);
      let posY = scaleByPixelRatio(e.clientY);
      updatePointerMoveData(pointers[0], posX, posY, generateColor());
      updateFrame();
